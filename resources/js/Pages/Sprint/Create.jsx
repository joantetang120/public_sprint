...
export default function Create({ tags = [] }) {
    ...
    useEffect(() => {
        ...
        setData('starts_at', tomorrow.toISOString().split('T')[0]);
    }, [setData]);
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-10">
                        ...
                        <div className="rounded-[28px] border border-stone-200 bg-[linear-gradient(135deg,#173327,#2f6b4f)] p-8 text-white shadow-lg">
                            <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.24em] text-emerald-50">
                                ...
                                <span>{tl('Ready to launch')}</span>
                            </div>
                            <h1 className="mt-5 font-display text-4xl font-black">{tl('Create Sprint')}</h1>
                            <p className="mt-3 max-w-2xl text-sm leading-7 text-emerald-50/80 sm:text-base">
                                {tl('Set up a new sprint with a clear goal, a start date, and tags that help the right people find it.')}
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
                            ...
                            >
                                <span>{processing ? tl('Creating...') : tl('Launch Sprint')}</span>
